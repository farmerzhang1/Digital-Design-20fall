...
#set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { sw[0] }]; #IO_L1P_T0_AD0P_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33     } [get_ports { D[0] }]; #IO_L9N_T1_DQS_AD3N_15 Sch=d[0]
set_property -dict { PACKAGE_PIN A13   IOSTANDARD LVCMOS33     } [get_ports { D[1] }]; #IO_L9P_T1_DQS_AD3P_15 Sch=d[1]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33     } [get_ports { D[2] }]; #IO_L8N_T1_AD10N_15 Sch=d[2]
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33     } [get_ports { D[3] }]; #IO_L8P_T1_AD10P_15 Sch=d[3]
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33     } [get_ports { AN[0] }]; #IO_L7N_T1_AD2N_15 Sch=an[0]
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33     } [get_ports { AN[1] }]; #IO_L7P_T1_AD2P_15 Sch=an[1]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33     } [get_ports { AN[2] }]; #IO_L10N_T1_AD11N_15 Sch=an[2]


## Button

set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L10P_T1_AD11P_15 Sch=btn
